...
DATAPATH_SOURCE = '/scratch/es5223/medsynth/data/jaypee/'
OUT_SOURCE = '/scratch/es5223/medsynth/data_syntheticCT/jaypee_orig_XCTjoin_norm_finetune_classification_splits/'
