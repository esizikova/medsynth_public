...
if TYPE=='orig':
    ...
    data_dir = '/scratch/xc2057/medsynth/data_syntheticCT/TBX11K_orig_XCT_classification_splits/'
elif TYPE=='proj+ns':
...
VITWEIGHT = '/scratch/es5223/medsynth/pretrained/classification/CT_proj_GRAY_vit_small_patch16_224_TRIAL_0.pth'
CNN3DWEIGHT = '/scratch/xc2057/medsynth/pretrained/classification/models_trials/3D_CNN_bce_allSlice+10.0proj2.pth'

    
for TRIAL in range(3):
    CHECK_POINT_PATH = '/scratch/xc2057/medsynth/pretrained/classification/models_trials/X+CT-joinedModel-3DCNN_CT_pretrained'+str(TYPE)+'_TRIAL_'+str(TRIAL)+'.pth'
    ...
    CNN3D_pretrained_state_dict = torch.load(CNN3DWEIGHT)    
    model.model_ct.load_state_dict(CNN3D_pretrained_state_dict["model_state_dict"], strict=False)
